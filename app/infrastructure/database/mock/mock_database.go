...
func (m *MockDatabase) FindUserByEmail(email string) (user.User, bool) {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) FindUserByID(id domains.ID) (user.User, bool) {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) FindUserByCookie(cookie *http.Cookie) (user.User, bool) {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) FindUsersByIDs(ids []domains.ID) ([]user.User, bool) {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) FindFilmByTitle(title string) (film.Film, bool) {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) FindFilmByID(id domains.ID) (film.Film, bool) {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) FindFilmsByIDs(ids []domains.ID) ([]film.Film, bool) {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) FindReviewByID(id domains.ID) (review.Review, bool) {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) GetFilmsSortedByMark(limit, offset int) ([]film.Film, *domains.Error) {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) GetFilmsOfGenreSortedByMark(genre domains.Genre, limit, offset int) ([]film.Film, *domains.Error) {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) GetFilmsOfYearSortedByMark(year string, limit, offset int) ([]film.Film, *domains.Error) {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) GetReviewsSortedByDate(limit, offset int) ([]review.Review, *domains.Error) {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) GetReviewsOfFilmSortedByDate(filmID domains.ID, limit, offset int) ([]review.Review, *domains.Error) {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) GetReviewsOfAuthorSortedByDate(authorID domains.ID, limit, offset int) ([]review.Review, *domains.Error) {
	m.ctrl.T.Helper()
