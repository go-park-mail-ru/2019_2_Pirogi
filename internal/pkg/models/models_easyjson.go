		...
		case "persons":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Persons = append(out.Persons, v41)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "countries":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Countries = append(out.Countries, v47)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "persons":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Persons = append(out.Persons, v48)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonD2b7633eEncodeGithubComGoParkMailRu20192PirogiInternalPkgModels17(out *jwriter.Writer, in FilmFull) {
	...
	}
	{
		...
		if in.Countries == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v52, v53 := range in.Countries {
				if v52 > 0 {
					out.RawByte(',')
				}
		...
		case "countries":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Countries = append(out.Countries, v59)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "persons_id":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v60 ID
					v60 = ID(in.Int())
					out.PersonsID = append(out.PersonsID, v60)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "images":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v61 Image
					v61 = Image(in.String())
					out.Images = append(out.Images, v61)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonD2b7633eEncodeGithubComGoParkMailRu20192PirogiInternalPkgModels18(out *jwriter.Writer, in Film) {
	...
	}
	{
		...
		if in.Countries == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v64, v65 := range in.Countries {
				if v64 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.PersonsID == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v66, v67 := range in.PersonsID {
				if v66 > 0 {
					out.RawByte(',')
				}
				out.Int(int(v67))
