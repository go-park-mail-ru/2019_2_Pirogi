		...
		case "actors":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Actors = append(out.Actors, v44)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "directors":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Directors = append(out.Directors, v45)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "genres":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v47 Genre
					v47 = Genre(in.String())
					out.Genres = append(out.Genres, v47)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonD2b7633eEncodeGithubComGoParkMailRu20192PirogiInternalPkgModels14(out *jwriter.Writer, in Film) {
	...
	}
	{
		...
		if in.Countries == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v48, v49 := range in.Countries {
				if v48 > 0 {
					out.RawByte(',')
				}
	...
	}
	{
		...
		if in.Directors == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v52, v53 := range in.Directors {
				if v52 > 0 {
					out.RawByte(',')
				}
